        ...
        <div class="w-full max-w-6xl m-auto bg-indigo-100 rounded flex overflow-hidden">   
            ...
            <div id="slider-login-1" class="w-6/12 p-5 bg-red-800 relative overflow-hidden">
                ...
                <div class="relative flex justify-center align-center content-end h-full">
                    <div class="absolute h-full w-full flex justify-center align-center">
                        <img id="slider-1" src="img/login-layout-2-1.png" class="transition-set w-5/5 h-auto object-contain bottom-5 active-slider" >
                    </div>
                    <div class="absolute h-full w-full flex justify-center align-center">
                        <img id="slider-2" src="img/login-layout-2-2.png" class="transition-set w-5/5 h-auto object-contain bottom-5 opacity-0">
                    </div>
                    <div class="absolute h-full w-full flex justify-center align-center">
                        <img id="slider-3" src="img/login-layout-2-3.png" class="transition-set w-5/5 h-auto object-contain bottom-5 opacity-0">
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        autoSliderFunctionLoad: function(){
