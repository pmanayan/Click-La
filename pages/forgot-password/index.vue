        ...
        <div class="w-full max-w-6xl m-auto bg-indigo-100 rounded flex overflow-hidden">   
            <div class="w-6/12 p-10">
                ...
                <div class="flex justify-center mb-5">
                    <h1 class="text-3xl font-bold text-red-800">Reset Password</h1>
                </div>
                <form class="w-4/5 m-auto">
                    <div>
                        <label class="block mb-2 text-red-800 font-bold" for="email">Email</label>
                        <input class="w-full p-2 mb-6 text-gray-800 border-b-2 border-red-800 outline-none focus:bg-gray-300" type="text" name="email"/>
                    </div>
                    <div>          
